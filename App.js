...
export default function App() {
  ...
  useEffect(() => {
    ...
    Animated.parallel([
      //Permite executar duas animações ao mesmo tempo
    ...
    <KeyboardAvoidingView style={styles.background}>
      <View style={styles.containerLogo}>
        <Animated.Image
          ...
          source={require('./src/assets/logoYoutube/logo.png')}
        />
      </View>

      <Animated.View
        style={[
          //será adicionado efeito neste style
          styles.container,
          {
            opacity: opacity,
...
const styles = StyleSheet.create({
  ...
  input: {
    backgroundColor: '#000', // coloração do elemento
    width: '90%',
    marginBottom: 15,
    color: '#222', // coloração do texto
    fontSize: 17,
    borderRadius: 7,
    padding: 10,
  },
